...
2. `treasury/treasury_governance_contract.py`
3. `entry-token/asset.template.json`
4. `soulbound/asset.template.json`
...
- The treasury scaffold stores vote and request data in boxes keyed by spend-request id.
